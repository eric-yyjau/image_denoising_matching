...
''' Define filters '''
multi_bilateral = MultiBilateralEst(wavelet_type = 'db8', wavelet_levels = 2, 
...
img_mgt = np.clip(multi_guided.denoise(img, d=3, sigmaSpace=1.8),0,1)
